...
describe("@proxy policy", () => {
  ...
  describe("proxyOptions", () => {
    ...
    describe("when incorrect proxy options are provided", () => {
      ...
      it.skip("responds with a bad gateway error", () =>
      ...
      return gateway({
        config: {
          gatewayConfig: {
            http: { port: 0 },
            apiEndpoints: {
              testStar: { path: "/hello/v1/api/endpointStar*splat" },
              testStarSlash: {
                path: "/hello/v1/api/endpointSlashedStar/{*splat}",
              },
              testTwoStars: {
                path: "/hello/v1/api/endpointTwoStar/*splat1/then/*splat2",
              },
